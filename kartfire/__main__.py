...
def main():
	...
	parser.add_argument("-t", "--testcase", metavar = "filename", action = "append", required = True, help = "Testcase definition JSON file. Can be given multiple times to join testcases. Mandatory argument.")
